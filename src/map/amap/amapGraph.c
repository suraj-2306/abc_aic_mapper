...
Amap_Obj_t* Amap_ManCreatePo(Amap_Man_t* p, Amap_Obj_t* pFan0) {
    ...
    pObj->Fan[0] = Amap_ObjToLit(pFan0);
    Amap_Regular(pFan0)->nRefs++;
...
Amap_Obj_t* Amap_ManCreateAnd(Amap_Man_t* p, Amap_Obj_t* pFan0, Amap_Obj_t* pFan1) {
    ...
    pObj->Fan[0] = Amap_ObjToLit(pFan0);
    Amap_Regular(pFan0)->nRefs++;
    pObj->Fan[1] = Amap_ObjToLit(pFan1);
    Amap_Regular(pFan1)->nRefs++;
...
Amap_Obj_t* Amap_ManCreateMux(Amap_Man_t* p, Amap_Obj_t* pFan0, Amap_Obj_t* pFan1, Amap_Obj_t* pFanC) {
    ...
    pObj->Fan[1] = Amap_ObjToLit(pFan1);
    Amap_Regular(pFan1)->nRefs++;
    pObj->Fan[2] = Amap_ObjToLit(pFanC);
    Amap_Regular(pFanC)->nRefs++;
    pObj->fPhase = (Amap_ObjPhaseReal(pFan1) & Amap_ObjPhaseReal(pFanC)) | (Amap_ObjPhaseReal(pFan0) & ~Amap_ObjPhaseReal(pFanC));
...
void Amap_ManCreate(Amap_Man_t* p, Aig_Man_t* pAig) {
    ...
    Aig_ManForEachCo(pAig, pObj, i)
        pObj->pData
        = Amap_ManCreatePo(p, (Amap_Obj_t*)Aig_ObjChild0Copy(pObj));
    if (p->pPars->fVerbose)
