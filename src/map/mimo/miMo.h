...
struct MiMo_CellPinOut_t_ {
  ...
  MiMo_CellFanout_t
      *pFanoutList; // all fanouts of this (pin, fanoutNetId) combination
...
static inline char *MiMo_PinDelayInName(MiMo_PinDelay_t *pDelay) {
  return (pDelay->fFromPinOut ? ((MiMo_PinOut_t *)pDelay->pFromPin)->pName
                              : ((MiMo_PinIn_t *)pDelay->pFromPin)->pName);
}
static inline MiMo_PinOut_t *MiMo_PinOutAt(MiMo_Gate_t *pGate, int id) {
  return Vec_PtrEntry(pGate->pPinOuts, id);
}
static inline MiMo_PinIn_t *MiMo_PinInAt(MiMo_Gate_t *pGate, int id) {
  return Vec_PtrEntry(pGate->pPinIns, id);
}

static inline int MiMo_GateIsConst1(MiMo_Gate_t *pGate) {
  return (pGate ? pGate->pMiMoLib->pGate1 == pGate : 0);
}
static inline int MiMo_GateIsConst0(MiMo_Gate_t *pGate) {
  return (pGate ? pGate->pMiMoLib->pGate0 == pGate : 0);
}
static inline int MiMo_GateIsConst(MiMo_Gate_t *pGate) {
  return MiMo_GateIsConst1(pGate) || MiMo_GateIsConst0(pGate);
}
static inline int MiMo_GateIsBuf(MiMo_Gate_t *pGate) {
  return (pGate ? pGate->pMiMoLib->pGateBuf == pGate : 0);
}
static inline int MiMo_GateIsSpecial(MiMo_Gate_t *pGate) {
  return MiMo_GateIsConst(pGate) || MiMo_GateIsBuf(pGate);
}
...
extern void MiMo_CellAddPinIn(MiMo_Cell_t *pCell, MiMo_PinIn_t *pPinIn,
                              int faninId);
extern int MiMo_CellAddPinOut(MiMo_Cell_t *pCell, MiMo_PinOut_t *pPinOut,
                              int fanoutId);
...
extern void MiMo_DelayListSetDelay(MiMo_PinOut_t *pPinOut,
                                   MiMo_PinDelay_t *pLast, float delay);
extern int MiMo_DelayListAdd(MiMo_Gate_t *pGate, MiMo_PinOut_t *pToPinOut,
                             char *pFromPinStr);
