...
void If_Dec10Verify(word* pF, int nVars, unsigned* pZ) {
    ...
    for (w = 0; w < nWords; w++)
        if (pN[k][w] != pF[w]) {
            ...
            printf("\n");
            Kit_DsdPrintFromTruth((unsigned*)pN[k], nVars);
            printf("\n");
    ...
    for (i0 = 0; i0 < v; i0++)
        for (i1 = i0 + 1; i1 < v; i1++) {
            ...
            if (nVars == 10) {
                ...
                if ((Count[i0] == 2 && Count[i1] == 2) || (Count[i0] == 2 && Count[i1] < 0) || (Count[i0] < 0 && Count[i1] == 2))
                    return 1;
            } else {
                if ((Count[i0] == 2 && Count[i1] == 2) || (Count[i0] == 2 && Count[i1] < 0) || (Count[i0] < 0 && Count[i1] == 2) || (Count[i0] < 0 && Count[i1] < 0))
                    return 1;
            }
        }
    //    printf( "not found\n" );
