...
void If_Dec6Verify(word t, word z) {
    ...
    if (r != t) {
        ...
        Kit_DsdPrintFromTruth((unsigned*)&r, 6);
        printf("\n");
...
void If_Dec7Verify(word t[2], word z) {
    ...
    if (r[0] != t[0] || r[1] != t[1]) {
        If_DecPrintConfig(z);
        Kit_DsdPrintFromTruth((unsigned*)t, 7);
        printf("\n");
        Kit_DsdPrintFromTruth((unsigned*)r, 7);
        printf("\n");
        printf("Verification failed!\n");
    }
}
...
static inline int If_Dec6CheckMux(word t) {
    int v;
    for (v = 0; v < 6; v++)
        if (If_Dec6SuppSize(If_Dec6Cofactor(t, v, 0)) < 5 && If_Dec6SuppSize(If_Dec6Cofactor(t, v, 1)) < 5)
            return v;
    return -1;
}
...
static inline word If_Dec5CofCount2(word t, int x, int y, int* Pla2Var, word t0, int fDerive) {
    ...
    if (!fDerive)
        ...
        // verify
        {
            ...
            if (t1 != t0) {
                printf("\n");
                Kit_DsdPrintFromTruth((unsigned*)&C2[0], 5);
                printf("\n");
                Kit_DsdPrintFromTruth((unsigned*)&C2[1], 5);
                printf("\n");
                Kit_DsdPrintFromTruth((unsigned*)&C2[2], 5);
                printf("\n");
                Kit_DsdPrintFromTruth((unsigned*)&C2[3], 5);
                printf("\n");

                printf("\n");
                Kit_DsdPrintFromTruth((unsigned*)&D2[0], 5);
                printf("\n");
                Kit_DsdPrintFromTruth((unsigned*)&D2[1], 5);
                printf("\n");
                Kit_DsdPrintFromTruth((unsigned*)&D2[2], 5);
                printf("\n");
                Kit_DsdPrintFromTruth((unsigned*)&D2[3], 5);
                printf("\n");

                printf("\n");
                Kit_DsdPrintFromTruth((unsigned*)&C, 5);
                printf("\n");
                Kit_DsdPrintFromTruth((unsigned*)&D, 5);
                printf("\n");

                printf("\n");
                Kit_DsdPrintFromTruth((unsigned*)&t1, 5);
                printf("\n");
                Kit_DsdPrintFromTruth((unsigned*)&t0, 5);
                printf("\n");
            }
            assert(t1 == t0);
        }
...
void If_Dec5PerformTest() {
    ...
    Kit_DsdPrintFromTruth((unsigned*)&t, 5);
    printf("\n");
