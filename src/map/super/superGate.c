        ...
        switch (nFanins) {
            ...
            case 1: // interter root
                Super_ManForEachGate(ppGatesLimit, nGatesLimit, i0, pGate0) {
                    ...
                    pSupers[0] = pGate0;
                    uTruths[0][0] = pGate0->uTruth[0];
                    uTruths[0][1] = pGate0->uTruth[1];
                    ptPinDelays[0] = pGate0->ptDelays;
            ...
            case 2: // two-input root gate
                Super_ManForEachGate(ppGatesLimit, nGatesLimit, i0, pGate0) {
                    ...
                    uTruths[0][1] = pGate0->uTruth[1];
                    ptPinDelays[0] = pGate0->ptDelays;
                    Super_ManForEachGate(ppGatesLimit, nGatesLimit, i1, pGate1) if (i1 != i0) {
                        ...
                        pSupers[1] = pGate1;
                        uTruths[1][0] = pGate1->uTruth[0];
                        uTruths[1][1] = pGate1->uTruth[1];
                        ptPinDelays[1] = pGate1->ptDelays;
                        Mio_DeriveGateDelays(ppGates[k], ptPinDelays, nFanins, pMan->nVarsMax, SUPER_NO_VAR, tPinDelaysRes, &tPinDelayMax);
                        Mio_DeriveTruthTable(ppGates[k], uTruths, nFanins, pMan->nVarsMax, uTruth);
                        if (!Super_CompareGates(pMan, uTruth, Area, tPinDelaysRes, pMan->nVarsMax))
                            continue;
            ...
            case 3: // three-input root gate
                Super_ManForEachGate(ppGatesLimit, nGatesLimit, i0, pGate0) {
                    ...
                    Super_ManForEachGate(ppGatesLimit, nGatesLimit, i1, pGate1) if (i1 != i0) {
                        ...
                        Super_ManForEachGate(ppGatesLimit, nGatesLimit, i2, pGate2) if (i2 != i0 && i2 != i1) {
                            if (fTimeOut) goto done;
                            fTimeOut = Super_CheckTimeout(pProgress, pMan);
                            // compute area
                            ...
                            if (pMan->tAreaMax > 0.0 && Area > pMan->tAreaMax)
                                break;
                            pSupers[2] = pGate2;
                            uTruths[2][0] = pGate2->uTruth[0];
                            uTruths[2][1] = pGate2->uTruth[1];
                            ptPinDelays[2] = pGate2->ptDelays;
                ...
                Super_ManForEachGate(ppGatesLimit, nGatesLimit, i0, pGate0) {
                    ...
                    Super_ManForEachGate(ppGatesLimit, nGatesLimit, i1, pGate1) if (i1 != i0) {
                        ...
                        Super_ManForEachGate(ppGatesLimit, nGatesLimit, i2, pGate2) if (i2 != i0 && i2 != i1) {
                            ...
                            Super_ManForEachGate(ppGatesLimit, nGatesLimit, i3, pGate3) if (i3 != i0 && i3 != i1 && i3 != i2) {
                                if (fTimeOut) goto done;
                                fTimeOut = Super_CheckTimeout(pProgress, pMan);
                                // compute area
                                ...
                                if (pMan->tAreaMax > 0.0 && Area > pMan->tAreaMax)
                                    break;
                                pSupers[3] = pGate3;
                                uTruths[3][0] = pGate3->uTruth[0];
                                uTruths[3][1] = pGate3->uTruth[1];
                                ptPinDelays[3] = pGate3->ptDelays;
                    ...
                    Super_ManForEachGate(ppGatesLimit, nGatesLimit, i1, pGate1) if (i1 != i0) {
                        ...
                        Super_ManForEachGate(ppGatesLimit, nGatesLimit, i2, pGate2) if (i2 != i0 && i2 != i1) {
                            ...
                            Super_ManForEachGate(ppGatesLimit, nGatesLimit, i3, pGate3) if (i3 != i0 && i3 != i1 && i3 != i2) {
                                ...
                                Super_ManForEachGate(ppGatesLimit, nGatesLimit, i4, pGate4) if (i4 != i0 && i4 != i1 && i4 != i2 && i4 != i3) {
                                    if (fTimeOut) goto done;
                                    fTimeOut = Super_CheckTimeout(pProgress, pMan);
                                    // compute area
                                    ...
                                    if (pMan->tAreaMax > 0.0 && Area > pMan->tAreaMax)
                                        break;
                                    pSupers[4] = pGate4;
                                    uTruths[4][0] = pGate4->uTruth[0];
                                    uTruths[4][1] = pGate4->uTruth[1];
                                    ptPinDelays[4] = pGate4->ptDelays;
                        ...
                        Super_ManForEachGate(ppGatesLimit, nGatesLimit, i2, pGate2) if (i2 != i0 && i2 != i1) {
                            ...
                            Super_ManForEachGate(ppGatesLimit, nGatesLimit, i3, pGate3) if (i3 != i0 && i3 != i1 && i3 != i2) {
                                ...
                                Super_ManForEachGate(ppGatesLimit, nGatesLimit, i4, pGate4) if (i4 != i0 && i4 != i1 && i4 != i2 && i4 != i3) {
                                    ...
                                    Super_ManForEachGate(ppGatesLimit, nGatesLimit, i5, pGate5) if (i5 != i0 && i5 != i1 && i5 != i2 && i5 != i3 && i5 != i4) {
                                        if (fTimeOut) goto done;
                                        fTimeOut = Super_CheckTimeout(pProgress, pMan);
                                        // compute area
                                        ...
                                        if (pMan->tAreaMax > 0.0 && Area > pMan->tAreaMax)
                                            break;
                                        pSupers[5] = pGate5;
                                        uTruths[5][0] = pGate5->uTruth[0];
                                        uTruths[5][1] = pGate5->uTruth[1];
                                        ptPinDelays[5] = pGate5->ptDelays;
