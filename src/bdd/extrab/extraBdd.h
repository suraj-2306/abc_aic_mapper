...
#define hashKey4(a, b, c, d, TSIZE) \
    ((((((ABC_PTRUINT_T)(a) + (ABC_PTRUINT_T)(b)) * DD_P1 + (ABC_PTRUINT_T)(c)) * DD_P2 + (ABC_PTRUINT_T)(d)) * DD_P3) % TSIZE)

#define hashKey5(a, b, c, d, e, TSIZE) \
    (((((((ABC_PTRUINT_T)(a) + (ABC_PTRUINT_T)(b)) * DD_P1 + (ABC_PTRUINT_T)(c)) * DD_P2 + (ABC_PTRUINT_T)(d)) * DD_P3 + (ABC_PTRUINT_T)(e)) * DD_P1) % TSIZE)
