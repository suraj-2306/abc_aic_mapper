...
void Aig_ManDomStop(Aig_Sto_t* pSto) {
    Vec_Ptr_t* vDoms;
    int i;
    Vec_PtrForEachEntry(Vec_Ptr_t*, pSto->vDoms, vDoms, i) if (vDoms)
...
void Aig_ObjDomCompute(Aig_Sto_t* pSto, Aig_Obj_t* pObj) {
    ...
    Aig_ObjForEachFanout(pSto->pAig, pObj, pFanout, iFanout, i) if (Aig_ObjIsTravIdCurrent(pSto->pAig, pFanout))
...
Aig_Sto_t* Aig_ManComputeDomsFlops(Aig_Man_t* pAig, int Limit) {
    ...
    Vec_PtrForEachEntry(Aig_Obj_t*, vNodes, pObj, i) if (Aig_ObjIsTravIdCurrent(pSto->pAig, pObj))
...
int Aig_ObjDomVolume(Aig_Sto_t* pSto, Aig_Dom_t* pDom) {
    ...
    Aig_DomForEachNode(pSto->pAig, pDom, pObj, i)
        Counter
        += Aig_ObjDomVolume_rec(pSto->pAig, pObj);
    return Counter;
}
