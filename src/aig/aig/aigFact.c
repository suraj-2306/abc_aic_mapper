...
Aig_Obj_t* Aig_SuppMinReconstruct(Aig_Man_t* p, Vec_Ptr_t* vCofs, Vec_Ptr_t* vNodes, Vec_Ptr_t* vSupp) {
    ...
    Vec_PtrForEachEntry(Aig_Obj_t*, vCofs, pObj, i)
        Aig_Regular(pObj)
            ->pData
        = Aig_NotCond(Aig_ManConst1(p), Aig_IsComplement(pObj));
...
int Aig_SuppMinGateIsInSupport(Aig_Man_t* p, Vec_Ptr_t* vOrGate, Vec_Ptr_t* vSupp) {
    ...
    Vec_PtrForEachEntry(Aig_Obj_t*, vOrGate, pObj, i) if (!Aig_ObjIsTravIdCurrent(p, Aig_Regular(pObj))) return 0;
    return 1;
}
...
int Aig_SuppMinHighlightCone_rec(Aig_Man_t* p, Aig_Obj_t* pObj) {
    ...
    if (Aig_ObjIsCi(pObj))
        return 0;
    RetValue = Aig_SuppMinHighlightCone_rec(p, Aig_ObjFanin0(pObj)) | Aig_SuppMinHighlightCone_rec(p, Aig_ObjFanin1(pObj));
...
void Aig_ManSupportMinimizationTest() {
    ...
    Aig_ObjPrint(p, Aig_Regular(pRes));
    printf("\n");
    Aig_ObjPrint(p, Aig_ObjFanin0(Aig_Regular(pRes)));
    printf("\n");
    Aig_ObjPrint(p, Aig_ObjFanin1(Aig_Regular(pRes)));
    printf("\n");
