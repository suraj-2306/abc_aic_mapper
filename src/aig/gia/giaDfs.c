...
int Gia_ManSuppSize_rec(Gia_Man_t* p, Gia_Obj_t* pObj) {
    ...
    if (Gia_ObjIsCi(pObj))
        return 1;
    assert(Gia_ObjIsAnd(pObj));
    return Gia_ManSuppSize_rec(p, Gia_ObjFanin0(pObj)) + Gia_ManSuppSize_rec(p, Gia_ObjFanin1(pObj));
}
...
int Gia_ManSuppSizeTest(Gia_Man_t* p) {
    ...
    int i, Counter = 0;
    abctime clk = Abc_Clock();
    Gia_ManForEachObj(p, pObj, i) if (Gia_ObjIsAnd(pObj))
        Counter
        += (Gia_ManSuppSizeOne(p, pObj) <= 16);
...
int Gia_ManConeSize_rec(Gia_Man_t* p, Gia_Obj_t* pObj) {
    ...
    if (Gia_ObjIsCi(pObj))
        return 0;
    assert(Gia_ObjIsAnd(pObj));
    return 1 + Gia_ManConeSize_rec(p, Gia_ObjFanin0(pObj)) + Gia_ManConeSize_rec(p, Gia_ObjFanin1(pObj));
}
...
Vec_Int_t* Gia_ManOrderReverse(Gia_Man_t* p) {
    ...
    Gia_ManForEachObj(p, pObj, i) if (!Gia_ObjIsCo(pObj))
