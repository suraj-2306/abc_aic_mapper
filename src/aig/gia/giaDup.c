...
Gia_Man_t* Gia_ManDupOrderDfs(Gia_Man_t* p) {
    ...
    Gia_ManForEachCi(p, pObj, i) if (!~pObj->Value)
        pObj->Value
...
Gia_Man_t* Gia_ManDupOutputVec(Gia_Man_t* p, Vec_Int_t* vOutPres) {
    ...
    Gia_ManForEachPi(p, pObj, i)
        pObj->Value
        = Gia_ManAppendCi(pNew);
    Gia_ManForEachPo(p, pObj, i) if (Vec_IntEntry(vOutPres, i))
        Gia_ManDupOrderDfs_rec(pNew, p, Gia_ObjFanin0(pObj));
    Gia_ManForEachPo(p, pObj, i) if (Vec_IntEntry(vOutPres, i))
        pObj->Value
        = Gia_ManAppendCo(pNew, Gia_ObjFanin0Copy(pObj));
...
Gia_Man_t* Gia_ManDupOrderAiger(Gia_Man_t* p) {
    ...
    Gia_ManForEachAnd(p, pObj, i)
        pObj->Value
        = Gia_ManAppendAnd(pNew, Gia_ObjFanin0Copy(pObj), Gia_ObjFanin1Copy(pObj));
    Gia_ManForEachCo(p, pObj, i)
        pObj->Value
        = Gia_ManAppendCo(pNew, Gia_ObjFanin0Copy(pObj));
    Gia_ManDupRemapEquiv(pNew, p);
...
Gia_Man_t* Gia_ManDupLastPis(Gia_Man_t* p, int nLastPis) {
    ...
    Gia_ManForEachCi(p, pObj, i)
        pObj->Value
        = (i < Gia_ManCiNum(p) - nLastPis) ? ~0 : Gia_ManAppendCi(pNew);
    Gia_ManForEachAnd(p, pObj, i)
        pObj->Value
        = Gia_ManAppendAnd(pNew, Gia_ObjFanin0Copy(pObj), Gia_ObjFanin1Copy(pObj));
    Gia_ManForEachCo(p, pObj, i)
...
void Gia_ManCycle(Gia_Man_t* p, Abc_Cex_t* pCex, int nFrames) {
    ...
    for (i = 0; i < nFrames; i++) {
        Gia_ManForEachPi(p, pObj, k)
            pObj->fMark0
            = pCex ? Abc_InfoHasBit(pCex->pData, pCex->nRegs + i * pCex->nPis + k) : (1 & Gia_ManRandom(0));
        Gia_ManForEachAnd(p, pObj, k)
            pObj->fMark0
            = (Gia_ObjFanin0(pObj)->fMark0 ^ Gia_ObjFaninC0(pObj)) & (Gia_ObjFanin1(pObj)->fMark0 ^ Gia_ObjFaninC1(pObj));
        Gia_ManForEachCo(p, pObj, k)
            pObj->fMark0
            = Gia_ObjFanin0(pObj)->fMark0 ^ Gia_ObjFaninC0(pObj);
...
Gia_Man_t* Gia_ManDup2(Gia_Man_t* p1, Gia_Man_t* p2) {
    ...
    Gia_ManForEachCi(p1, pObj, i)
        pObj->Value
        = Gia_ManCi(p2, i)->Value = Gia_ManAppendCi(pNew);
...
Gia_Man_t* Gia_ManDupAddBufs(Gia_Man_t* p) {
    ...
    Gia_ManForEachCi(p, pObj, i)
        pObj->Value
        = Gia_ManAppendBuf(pNew, pObj->Value);
    Gia_ManForEachAnd(p, pObj, i)
        pObj->Value
        = Gia_ManHashAnd(pNew, Gia_ObjFanin0Copy(pObj), Gia_ObjFanin1Copy(pObj));
    Gia_ManForEachCo(p, pObj, i)
...
Gia_Man_t* Gia_ManDupPerm(Gia_Man_t* p, Vec_Int_t* vPiPerm) {
    ...
    Gia_ManForEachPi(p, pObj, i)
        ...
        Gia_ManPi(p, Vec_IntEntry(vPiPerm, i))
            ->Value
        = Gia_ManAppendCi(pNew);
...
Gia_Man_t* Gia_ManDupPermFlop(Gia_Man_t* p, Vec_Int_t* vFfPerm) {
    ...
    Gia_ManForEachRo(p, pObj, i)
        ...
        Gia_ManRo(p, Vec_IntEntry(vFfPerm, i))
            ->Value
        = Gia_ManAppendCi(pNew);
    Gia_ManForEachAnd(p, pObj, i)
        pObj->Value
    ...
    Gia_ManForEachRi(p, pObj, i)
        ...
        pObj->Value
        = Gia_ManAppendCo(pNew, Gia_ObjFanin0Copy(Gia_ManRi(p, Vec_IntEntry(vFfPerm, i))));
...
Gia_Man_t* Gia_ManDupSpreadFlop(Gia_Man_t* p, Vec_Int_t* vFfMask) {
    ...
    Gia_ManForEachPi(p, pObj, i)
        ...
        = Gia_ManAppendCi(pNew);
    k = 0;
    Vec_IntForEachEntry(vFfMask, Entry, i) if (Entry == -1)
        Gia_ManAppendCi(pNew);
    else Gia_ManRo(p, k++)->Value = Gia_ManAppendCi(pNew);
...
void Gia_ManDupRebuild(Gia_Man_t* pNew, Gia_Man_t* p, Vec_Int_t* vLits, int fBufs) {
    ...
    Gia_ManForEachCi(p, pObj, i)
        pObj->Value
        = Vec_IntEntry(vLits, i);
    Gia_ManForEachAnd(p, pObj, i) if (fBufs && Gia_ObjIsBuf(pObj))
        pObj->Value
        = Gia_ManAppendBuf(pNew, Gia_ObjFanin0Copy(pObj));
    else pObj->Value = Gia_ManHashAnd(pNew, Gia_ObjFanin0Copy(pObj), Gia_ObjFanin1Copy(pObj));
    Vec_IntClear(vLits);
    Gia_ManForEachCo(p, pObj, i)
...
Gia_Man_t* Gia_ManDupAppendCones(Gia_Man_t* p, Gia_Man_t** ppCones, int nCones, int fOnlyRegs) {
    ...
    for (k = 0; k < nCones; k++) {
        ...
        Gia_ManForEachPi(pOne, pObj, i)
            pObj->Value
            = Gia_ManCiLit(pNew, fOnlyRegs ? Gia_ManPiNum(p) + i : i);
...
Gia_Man_t* Gia_ManDupSelf(Gia_Man_t* p) {
    ...
    Gia_ManForEachRi(p, pObj, i)
        pObj->Value
        = Gia_ManHashMux(pNew, iCtrl, Gia_ObjFanin0Copy(pObj), Gia_ObjRiToRo(p, pObj)->Value);
    Gia_ManForEachCo(p, pObj, i)
        Gia_ManAppendCo(pNew, pObj->Value);
    Gia_ManHashStop(pNew);
    Gia_ManSetRegNum(pNew, Gia_ManRegNum(p));
...
Gia_Man_t* Gia_ManDupFlopClass(Gia_Man_t* p, int iClass) {
    ...
    Gia_ManForEachPi(p, pObj, i)
        pObj->Value
        = Gia_ManAppendCi(pNew);
    Gia_ManForEachRo(p, pObj, i) if (Vec_IntEntry(p->vFlopClasses, i) != iClass)
        pObj->Value
        = Gia_ManAppendCi(pNew);
    Gia_ManForEachRo(p, pObj, i) if (Vec_IntEntry(p->vFlopClasses, i) == iClass)
        pObj->Value
    ...
    Gia_ManForEachPo(p, pObj, i)
        Gia_ManAppendCo(pNew, Gia_ObjFanin0Copy(pObj));
    Gia_ManForEachRi(p, pObj, i) if (Vec_IntEntry(p->vFlopClasses, i) != iClass)
        Gia_ManAppendCo(pNew, Gia_ObjFanin0Copy(pObj));
    Gia_ManForEachRi(p, pObj, i) if (Vec_IntEntry(p->vFlopClasses, i) == iClass)
        Gia_ManAppendCo(pNew, Gia_ObjFanin0Copy(pObj)),
        Counter2++;
...
Gia_Man_t* Gia_ManDupDfs2(Gia_Man_t* p) {
    ...
    Gia_ManForEachCi(p, pObj, i) if (~pObj->Value == 0)
        pObj->Value
        = Gia_ManAppendCi(pNew);
    assert(Gia_ManCiNum(pNew) == Gia_ManCiNum(p));
...
Gia_Man_t* Gia_ManDupDfsOnePo(Gia_Man_t* p, int iPo) {
    ...
    Gia_ManForEachCi(p, pObj, i)
        pObj->Value
        = Gia_ManAppendCi(pNew);
    Gia_ManForEachCo(p, pObj, i) if (!Gia_ObjIsPo(p, pObj) || i == iPo)
        Gia_ManDupDfs_rec(pNew, p, Gia_ObjFanin0(pObj));
    Gia_ManForEachCo(p, pObj, i) if (!Gia_ObjIsPo(p, pObj) || i == iPo)
        pObj->Value
        = Gia_ManAppendCo(pNew, Gia_ObjFanin0Copy(pObj));
...
Gia_Man_t* Gia_ManDupMux(int iVar, Gia_Man_t* pCof1, Gia_Man_t* pCof0) {
    ...
    for (n = 0; n < 2; n++) {
        ...
        Gia_ManForEachCi(pGia[n], pObj, i)
            pObj->Value
            = n ? Gia_ManCi(pGia[0], i)->Value : Gia_ManAppendCi(pNew);
...
Gia_Man_t* Gia_ManDupBlock(Gia_Man_t* p, int nBlock) {
    ...
    Gia_ManForEachCi(p, pObj, i)
        pObj->Value
        = (i % nBlock == 0) ? Gia_ManAppendCi(pNew) : 0;
    Gia_ManHashAlloc(pNew);
    Gia_ManForEachAnd(p, pObj, i)
        pObj->Value
        = Gia_ManHashAnd(pNew, Gia_ObjFanin0Copy(pObj), Gia_ObjFanin1Copy(pObj));
    Gia_ManForEachCo(p, pObj, i) if (i % nBlock == 0)
        Gia_ManAppendCo(pNew, Gia_ObjFanin0Copy(pObj));
...
Gia_Man_t* Gia_ManDupDfsSkip(Gia_Man_t* p) {
    ...
    Gia_ManForEachCi(p, pObj, i)
        pObj->Value
        = Gia_ManAppendCi(pNew);
    Gia_ManForEachCo(p, pObj, i) if (pObj->fMark1 == 0)
...
int Gia_ManDupConeBack(Gia_Man_t* p, Gia_Man_t* pNew, Vec_Int_t* vCiIds) {
    ...
    Gia_ManForEachCi(pNew, pObj, i)
        pObj->Value
        = Gia_Obj2Lit(p, Gia_ManCi(p, Vec_IntEntry(vCiIds, i)));
...
int Gia_ManDupConeBackObjs(Gia_Man_t* p, Gia_Man_t* pNew, Vec_Int_t* vObjs) {
    ...
    Gia_ManForEachCi(pNew, pObj, i)
        pObj->Value
        = Abc_Var2Lit(Vec_IntEntry(vObjs, i), 0);
    pRoot = Gia_ManCo(pNew, 0);
    Gia_ManDupConeBack_rec(p, pNew, Gia_ObjFanin0(pRoot));
    return Gia_ObjFanin0Copy(pRoot);
}
...
Vec_Int_t* Gia_ManDupTrimmedNonZero(Gia_Man_t* p) {
    ...
    Gia_ManForEachPo(pNonDual, pObj, i) if (!Gia_ObjIsConst0(Gia_ObjFanin0(pObj)))
...
Gia_Man_t* Gia_ManDupTrimmed(Gia_Man_t* p, int fTrimCis, int fTrimCos, int fDualOut, int OutValue) {
    ...
    Gia_ManCreateRefs(p);
    Gia_ManForEachPi(p, pObj, i) if (!fTrimCis || Gia_ObjRefNum(p, pObj)) break;
    if (i == Gia_ManPiNum(p)) // there is no PIs - add dummy PI
        Gia_ManAppendCi(pNew);
    // add the ROs
    Gia_ManFillValue(p);
    Gia_ManConst0(p)->Value = 0;
    Gia_ManForEachCi(p, pObj, i) if (!fTrimCis || Gia_ObjRefNum(p, pObj) || Gia_ObjIsRo(p, pObj))
        pObj->Value
        = Gia_ManAppendCi(pNew);
    Gia_ManForEachAnd(p, pObj, i)
        pObj->Value
    ...
    if (fDualOut && fTrimCos) {
        ...
        Gia_ManForEachPo(p, pObj, i) if (!fTrimCos || !Gia_ManPoIsToRemove(p, pObj, OutValue)) break;
        if (i == Gia_ManPoNum(p)) // there is no POs - add dummy PO
            Gia_ManAppendCo(pNew, 0);
        Gia_ManForEachCo(p, pObj, i) if (!fTrimCos || !Gia_ManPoIsToRemove(p, pObj, OutValue) || Gia_ObjIsRi(p, pObj))
            Gia_ManAppendCo(pNew, Gia_ObjFanin0Copy(pObj));
        Gia_ManSetRegNum(pNew, Gia_ManRegNum(p));
    }
...
Gia_Man_t* Gia_ManDupTrimmed2(Gia_Man_t* p) {
    ...
    Gia_ManForEachPi(p, pObj, i) if (Gia_ObjRefNum(p, pObj)) break;
    if (i == Gia_ManPiNum(p)) // there is no PIs - add dummy PI
        Gia_ManAppendCi(pNew);
    // add the ROs
    Gia_ManFillValue(p);
    Gia_ManConst0(p)->Value = 0;
    Gia_ManForEachCi(p, pObj, i) if (Gia_ObjRefNum(p, pObj) || Gia_ObjIsRo(p, pObj))
        pObj->Value
        = Gia_ManAppendCi(pNew);
    Gia_ManForEachAnd(p, pObj, i)
        pObj->Value
        = Gia_ManAppendAnd(pNew, Gia_ObjFanin0Copy(pObj), Gia_ObjFanin1Copy(pObj));
    // check if there are POs to be added
    Gia_ManForEachPo(p, pObj, i) if (!Gia_ObjIsConst0(Gia_ObjFanin0(pObj)) && !Gia_ObjIsPi(p, Gia_ObjFanin0(pObj))) break;
    if (i == Gia_ManPoNum(p)) // there is no POs - add dummy PO
        Gia_ManAppendCo(pNew, 0);
    Gia_ManForEachCo(p, pObj, i) if ((!Gia_ObjIsConst0(Gia_ObjFanin0(pObj)) && !Gia_ObjIsPi(p, Gia_ObjFanin0(pObj))) || Gia_ObjIsRi(p, pObj))
        Gia_ManAppendCo(pNew, Gia_ObjFanin0Copy(pObj));
    Gia_ManSetRegNum(pNew, Gia_ManRegNum(p));
    assert(!Gia_ManHasDangling(pNew));
    return pNew;
...
Gia_Man_t* Gia_ManDupTrimmed3(Gia_Man_t* p) {
    ...
    Gia_ManForEachPo(p, pObj, i) if (Vec_IntEntry(vMap, Gia_ObjFaninId0p(p, pObj)) == i)
        Gia_ManAppendCo(pNew, Gia_ObjFanin0Copy(pObj));
    Vec_IntFree(vMap);
    Gia_ManSetRegNum(pNew, Gia_ManRegNum(p));
    return pNew;
...
void Gia_ManPrintRepr(Gia_Man_t* p) {
    Gia_Obj_t* pObj;
    int i;
    Gia_ManForEachObj(p, pObj, i) if (~p->pReprsOld[i])
...
Gia_Man_t* Gia_ManDupTopAnd_iter(Gia_Man_t* p, int fVerbose) {
    ...
    Gia_ManForEachObj(p, pObj, i) if (!Gia_ObjIsCi(pObj) && (pVar2Val[i] == 0 || pVar2Val[i] == 1))
...
Gia_Man_t* Gia_ManMiter(Gia_Man_t* p0, Gia_Man_t* p1, int nInsDup, int fDualOut, int fSeq, int fImplic, int fVerbose) {
    ...
    if (fSeq) {
        ...
        Gia_ManForEachPi(p0, pObj, i)
            pObj->Value
            = Gia_ManAppendCi(pNew);
        Gia_ManForEachPi(p1, pObj, i) if (i < Gia_ManPiNum(p1) - nInsDup)
            pObj->Value
            = Gia_ObjToLit(pNew, Gia_ManPi(pNew, i));
        else pObj->Value = Gia_ManAppendCi(pNew);
        ...
        Gia_ManForEachCi(p0, pObj, i)
            pObj->Value
            = Gia_ManAppendCi(pNew);
        Gia_ManForEachCi(p1, pObj, i) if (i < Gia_ManCiNum(p1) - nInsDup)
            pObj->Value
            = Gia_ObjToLit(pNew, Gia_ManCi(pNew, i));
        else pObj->Value = Gia_ManAppendCi(pNew);
...
Gia_Man_t* Gia_ManMiterInverse(Gia_Man_t* pBot, Gia_Man_t* pTop, int fDualOut, int fVerbose) {
    ...
    Gia_ManForEachCo(pBot, pObj, i)
        pObj->Value
        = Gia_ObjFanin0Copy(pObj);
    Gia_ManForEachCi(pTop, pObj, i) if (i < nInputs1)
        pObj->Value
        = Gia_ManCi(pBot, i)->Value;
    else pObj->Value = Gia_ManCo(pBot, i - nInputs1)->Value;
...
Vec_Ptr_t* Gia_ManMiterNames(Vec_Ptr_t* p, int nOuts) {
    char *pName1, *pName2, pBuffer[1000];
    int i;
...
Vec_Int_t* Gia_ManCollectOneSide(Gia_Man_t* p, int iSide) {
    ...
    Gia_ManForEachPo(p, pObj, i) if ((i & 1) == iSide)
        Gia_ManCollectOneSide_rec(p, Gia_ObjFanin0(pObj), vNodes);
    return vNodes;
}
...
Gia_Man_t* Gia_ManDupZeroUndc(Gia_Man_t* p, char* pInit, int nNewPis, int fGiaSimple, int fVerbose) {
    ...
    Gia_ManForEachPo(p, pObj, i)
        ...
        = Gia_ManAppendCo(pNew, Gia_ObjFanin0Copy(pObj));
    // create flop inputs
    Gia_ManForEachRi(p, pObj, i) if (pInit[i] == '1')
        pObj->Value
        = Gia_ManAppendCo(pNew, Abc_LitNot(Gia_ObjFanin0Copy(pObj)));
    else pObj->Value = Gia_ManAppendCo(pNew, Gia_ObjFanin0Copy(pObj));
...
Gia_Man_t* Gia_ManMiter2(Gia_Man_t* pStart, char* pInit, int fVerbose) {
    ...
    Gia_ManForEachPi(pUndc, pObj, i) if (pInitNew[i] == 'x')
    ...
    Gia_ManForEachPo(pUndc, pObj, i)
        pObj->Value
        = Gia_ManAppendCo(pNew, Gia_ManHashXor(pNew, Vec_IntEntry(vCoValues0, i), Vec_IntEntry(vCoValues1, i)));
    // create flop inputs
    Gia_ManForEachRi(pUndc, pObj, i)
        pObj->Value
        = Gia_ManAppendCo(pNew, Vec_IntEntry(vCoValues0, Gia_ManPoNum(pUndc) + i));
    Gia_ManForEachRi(pUndc, pObj, i)
        pObj->Value
        = Gia_ManAppendCo(pNew, Vec_IntEntry(vCoValues1, Gia_ManPoNum(pUndc) + i));
...
Gia_Man_t* Gia_ManDupWithConstraints(Gia_Man_t* p, Vec_Int_t* vPoTypes) {
    ...
    Gia_ManForEachAnd(p, pObj, i)
        pObj->Value
        = Gia_ManAppendAnd(pNew, Gia_ObjFanin0Copy(pObj), Gia_ObjFanin1Copy(pObj));
    Gia_ManForEachPo(p, pObj, i) if (Vec_IntEntry(vPoTypes, i) == 0) // regular PO
        pObj->Value
        = Gia_ManAppendCo(pNew, Gia_ObjFanin0Copy(pObj));
    Gia_ManForEachPo(p, pObj, i) if (Vec_IntEntry(vPoTypes, i) == 1) // constraint (should be complemented!)
        pObj->Value
        = Gia_ManAppendCo(pNew, Gia_ObjFanin0Copy(pObj) ^ 1),
        nConstr++;
    Gia_ManForEachRi(p, pObj, i)
        pObj->Value
        = Gia_ManAppendCo(pNew, Gia_ObjFanin0Copy(pObj));
...
Gia_Man_t* Gia_ManDupCones(Gia_Man_t* p, int* pPos, int nPos, int fTrimPis) {
    ...
    Vec_PtrForEachEntryStart(Gia_Obj_t*, vRoots, pObj, i, nPos)
        Gia_ObjRiToRo(p, pObj)
            ->Value
        = Gia_ManAppendCi(pNew);
    // create internal nodes
    Vec_PtrForEachEntry(Gia_Obj_t*, vNodes, pObj, i) if (Gia_ObjIsXor(pObj))
        pObj->Value
        = Gia_ManAppendXor(pNew, Gia_ObjFanin0Copy(pObj), Gia_ObjFanin1Copy(pObj));
...
Gia_Man_t* Gia_ManDupAndCones(Gia_Man_t* p, int* pAnds, int nAnds, int fTrimPis) {
    ...
    // create internal nodes
    Vec_PtrForEachEntry(Gia_Obj_t*, vNodes, pObj, i) if (Gia_ObjIsMux(p, pObj))
        pObj->Value
        = Gia_ManAppendMux(pNew, Gia_ObjFanin2Copy(p, pObj), Gia_ObjFanin1Copy(pObj), Gia_ObjFanin0Copy(pObj));
...
Gia_Man_t* Gia_ManDupLevelized(Gia_Man_t* p) {
    ...
    Gia_ManForEachAnd(p, pObj, i)
        pNodes[pCounts[Gia_ObjLevel(p, pObj) - 1]++]
        = i;
    // duplicate
    pNew = Gia_ManStart(Gia_ManObjNum(p));
    pNew->pName = Abc_UtilStrsav(p->pName);
...
Gia_Man_t* Gia_ManDupSliced(Gia_Man_t* p, int nSuppMax) {
    ...
    Gia_ManForEachAnd(p, pObj, i) if (Gia_ManSuppSize(p, &i, 1) <= nSuppMax) {
        pObj->Value = Gia_ManAppendAnd(pNew, Gia_ObjFanin0Copy(pObj), Gia_ObjFanin1Copy(pObj));
        pObj->fMark0 = 1;
    }
    else {
...
Gia_Man_t* Gia_ManDupWithConstr(Gia_Man_t* p) {
    ...
    Gia_ManLevelNum(p);
    Vec_IntForEachEntry(vSuper, iLit, i) if (LevelBest < Gia_ObjLevelId(p, Abc_Lit2Var(iLit)))
        LevelBest
        = Gia_ObjLevelId(p, Abc_Lit2Var(iLit)),
        iLitBest = iLit;
    assert(iLitBest != -1);
    // create new manager
    pNew = Gia_ManStart(Gia_ManObjNum(p));
    ...
    Gia_ManForEachCo(p, pObj, i) {
        ...
        if (Vec_IntSize(vSuppOne) == 0)
            ...
            Vec_IntForEachEntry(vSuppOne, iCi, k)
                Gia_ManCi(p, iCi)
                    ->Value
                = Gia_Obj2Lit(pNew, Gia_ManCi(pNew, k));
            Gia_ManDupHashDfs_rec(pNew, p, Gia_ObjFanin0(pObj));
...
int Gia_ManCountMark0Dfs_rec(Gia_Man_t* p, int iObj) {
    ...
    if (!Gia_ObjIsAnd(pObj))
        return pObj->fMark0;
    return Gia_ManCountMark0Dfs_rec(p, Gia_ObjFaninId0(pObj, iObj)) + Gia_ManCountMark0Dfs_rec(p, Gia_ObjFaninId1(pObj, iObj)) + pObj->fMark0;
}
...
int Gia_ManCountMark1Dfs_rec(Gia_Man_t* p, int iObj) {
    ...
    if (!Gia_ObjIsAnd(pObj))
        return pObj->fMark1;
    return Gia_ManCountMark1Dfs_rec(p, Gia_ObjFaninId0(pObj, iObj)) + Gia_ManCountMark1Dfs_rec(p, Gia_ObjFaninId1(pObj, iObj)) + pObj->fMark1;
}
...
Vec_Int_t* Gia_ManCollectTopXors(Gia_Man_t* p) {
    ...
    if (Gia_ManCoNum(p) == 1) {
        ...
        Gia_ManForEachCo(p, pObj, i) if (Gia_ObjFaninId0p(p, pObj) > 0)
...
Vec_Int_t* Gia_ManCollectReach(Gia_Man_t* p, int fOdd) {
    ...
    Gia_ManIncrementTravId(p);
    Gia_ObjSetTravIdCurrent(p, Gia_ManConst0(p));
    Gia_ManForEachCoDriverId(p, iDriver, i) if ((i & 1) == fOdd)
    ...
    *pp0 = *pp1 = NULL;
    for (fOdd = 0; fOdd < 2; fOdd++) {
        ...
        Gia_ManForEachObjVec(vNodes, p, pObj, i)
            pObj->Value
            = Gia_ManAppendAnd(pNew, Gia_ObjFanin0Copy(pObj), Gia_ObjFanin1Copy(pObj));
        Gia_ManForEachCo(p, pObj, i) if ((i & 1) == fOdd)
            Gia_ManAppendCo(pNew, Gia_ObjFanin0Copy(pObj));
        Vec_IntFree(vNodes);
        if (fOdd)
            *pp1 = pNew;
...
Vec_Int_t* Gia_ManCollectReach2(Gia_Man_t* p, int fSecond) {
    ...
    Gia_ManIncrementTravId(p);
    Gia_ObjSetTravIdCurrent(p, Gia_ManConst0(p));
    Gia_ManForEachCoDriverId(p, iDriver, i) if ((i < Gia_ManCoNum(p) / 2) ^ fSecond)
        Gia_ManCollectDfs_rec(p, iDriver, vNodes);
    return vNodes;
}
    ...
    *pp0 = *pp1 = NULL;
    for (fSecond = 0; fSecond < 2; fSecond++) {
        ...
        Gia_ManForEachObjVec(vNodes, p, pObj, i)
            pObj->Value
            = Gia_ManAppendAnd(pNew, Gia_ObjFanin0Copy(pObj), Gia_ObjFanin1Copy(pObj));
        Gia_ManForEachCo(p, pObj, i) if ((i < Gia_ManCoNum(p) / 2) ^ fSecond)
            Gia_ManAppendCo(pNew, Gia_ObjFanin0Copy(pObj));
        Vec_IntFree(vNodes);
        if (fSecond)
            *pp1 = pNew;
...
Gia_Man_t* Gia_ManDupHalfSeq(Gia_Man_t* p, int fSecond) {
    ...
    if (fSecond) {
        ...
        Gia_ManForEachPo(p, pObj, i)
            Gia_ManDupOrderDfs_rec(pNew, p, pObj);
        Gia_ManForEachRi(p, pObj, i) if (i >= Gia_ManRegNum(p) / 2)
            Gia_ManDupOrderDfs_rec(pNew, p, pObj);
        ...
        Gia_ManForEachPi(p, pObj, i)
            pObj->Value
            = Gia_ManAppendCi(pNew);
        Gia_ManForEachRo(p, pObj, i) if (i >= Gia_ManRegNum(p) / 2)
            pObj->Value
            = Gia_ManAppendCi(pNew);
        Gia_ManForEachRo(p, pObj, i) if (i < Gia_ManRegNum(p) / 2)
            pObj->Value
...
void Gia_ManSeqEquivMerge(Gia_Man_t* p, Gia_Man_t* pPart[2]) {
    ...
    for (n = 0; n < 2; n++) {
        ...
        Gia_ManForEachClass(pPart[n], i) {
            ...
            if (n == 1) {
                Gia_ClassForEachObj(pPart[n], i, iObj) if (pClasses[Gia_ManObj(pPart[n], iObj)->Value] != -1)
                    Repr
                    = pClasses[Gia_ManObj(pPart[n], iObj)->Value];
            }
...
void Gia_ManPrintEquivs(Gia_Man_t* p) {
    ...
    int i, iObj;
    printf("Const0:");
    Gia_ManForEachAnd(p, pObj, i) if (Gia_ObjRepr(p, i) == 0)
        printf(" %d", i);
    printf("\n");
    Gia_ManForEachClass(p, i) {
        printf("%d:", i);
...
void Gia_ManSeqEquivDivide(Gia_Man_t* p, Cec_ParCor_t* pPars) {
    ...
    for (n = 0; n < 2; n++) {
        ...
        Gia_ManForEachObj(p, pObj, i) if (~pObj->Value)
            Gia_ManObj(pParts[n], Abc_Lit2Var(pObj->Value))
                ->Value
            = i;
    }
...
void Gia_ManHighLightFlopLogic(Gia_Man_t* p) {
    ...
    Gia_ManForEachAnd(p, pObj, i)
        pObj->fMark0
        = Gia_ObjFanin0(pObj)->fMark0 | Gia_ObjFanin1(pObj)->fMark0;
    Gia_ManForEachCo(p, pObj, i)
        pObj->fMark0
        = Gia_ObjFanin0(pObj)->fMark0;
}
...
Vec_Int_t* Gia_ManDupUifBoxTypes(Vec_Int_t* vBarBufs) {
    ...
    int i, Entry;
    Vec_IntForEachEntry(vBarBufs, Entry, i) if (Vec_IntFind(vTypes, Entry & 0xFFFE) < 0)
...
Vec_Wec_t** Gia_ManDupUifBuildMap(Gia_Man_t* p) {
    ...
    Gia_Obj_t* pObj;
    int i, Item, j, k = 0;
    Gia_ManForEachObj1(p, pObj, i) if (Gia_ObjIsBuf(pObj))
        Vec_IntPush(vBufs, i);
...
Vec_Int_t* Gia_ManDupBlackBoxBuildMap(Gia_Man_t* p) {
    Vec_Int_t* vMap = Vec_IntAlloc(p->nBufs);
    int i, Item;
    Vec_IntForEachEntry(p->vBarBufs, Item, i)
