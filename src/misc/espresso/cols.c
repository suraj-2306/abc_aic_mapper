 ...
 */
void
    sm_col_free(pcol) register sm_col* pcol;
{
 ...
 */
void
    sm_col_remove(pcol, row) register sm_col* pcol;
register int row;
{
    register sm_element* p;
 ...
 */
void
    sm_col_remove_element(pcol, p) register sm_col* pcol;
register sm_element* p;
{
    dll_unlink(p, pcol->first_row, pcol->last_row,
               next_row, prev_row, pcol->length);
