...
void
    sm_resize(A, row, col) register sm_matrix* A;
int row, col;
{
...
void
    sm_remove_element(A, p) register sm_matrix* A;
register sm_element* p;
{
    register sm_row* prow;
    register sm_col* pcol;
...
void
    sm_copy_row(dest, dest_row, prow) register sm_matrix* dest;
int dest_row;
sm_row* prow;
{
    register sm_element* p;
...
void
    sm_copy_col(dest, dest_col, pcol) register sm_matrix* dest;
int dest_col;
sm_col* pcol;
{
    register sm_element* p;
