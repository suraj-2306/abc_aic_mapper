 ...
 */
void
    sm_row_free(prow) register sm_row* prow;
{
 ...
 */
void
    sm_row_remove(prow, col) register sm_row* prow;
register int col;
{
    register sm_element* p;
 ...
 */
void
    sm_row_remove_element(prow, p) register sm_row* prow;
register sm_element* p;
{
    dll_unlink(p, prow->first_col, prow->last_col,
               next_col, prev_col, prow->length);
