...
int Fraig_MarkTfi_rec(Fraig_Man_t* pMan, Fraig_Node_t* pNode) {
    ...
    if (pNode->NumPi >= 0)
        return 1;
    // check the children
    return Fraig_MarkTfi_rec(pMan, Fraig_Regular(pNode->p1)) + Fraig_MarkTfi_rec(pMan, Fraig_Regular(pNode->p2));
}
...
int Fraig_MarkTfi2_rec(Fraig_Man_t* pMan, Fraig_Node_t* pNode) {
    ...
    if (pNode->NumPi >= 0)
        return 1;
    // check the children
    return Fraig_MarkTfi2_rec(pMan, Fraig_Regular(pNode->p1)) + Fraig_MarkTfi2_rec(pMan, Fraig_Regular(pNode->p2));
}
...
int Fraig_MarkTfi3_rec(Fraig_Man_t* pMan, Fraig_Node_t* pNode) {
    ...
    if (pNode->NumPi >= 0)
        return 0;
    // check the children
    return Fraig_MarkTfi3_rec(pMan, Fraig_Regular(pNode->p1)) * Fraig_MarkTfi3_rec(pMan, Fraig_Regular(pNode->p2));
}
