...
void Rnm_ManJustifyPropFanout_rec(Rnm_Man_t* p, Gia_Obj_t* pObj, int f, Vec_Int_t* vSelect) {
    ...
    Gia_ObjForEachFanoutStatic(p->pGia, pObj, pFanout, k) {
        ...
        if (((pRnm0->Value ^ Gia_ObjFaninC0(pFanout)) == 0 && pRnm0->fVisit) || ((pRnm1->Value ^ Gia_ObjFaninC1(pFanout)) == 0 && pRnm1->fVisit) || (((pRnm0->Value ^ Gia_ObjFaninC0(pFanout)) == 1 && pRnm0->fVisit) && ((pRnm1->Value ^ Gia_ObjFaninC1(pFanout)) == 1 && pRnm1->fVisit)))
            Rnm_ManJustifyPropFanout_rec(p, pFanout, f, vSelect);
    }
}
