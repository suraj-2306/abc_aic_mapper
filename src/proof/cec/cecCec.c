...
int Cec_ManHandleSpecialCases(Gia_Man_t* p, Cec_ParCec_t* pPars) {
    ...
    Gia_ManForEachPo(p, pObj1, i) {
        ...
        if ((Gia_ObjIsPi(p, pDri1) && Gia_ObjIsConst0(pDri2)) || (Gia_ObjIsPi(p, pDri2) && Gia_ObjIsConst0(pDri1))) {
            if (!pPars->fSilent) {
