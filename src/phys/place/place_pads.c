...
void globalPreplace(float utilization) {
    ...
    g_place_coreBounds.w = g_place_coreBounds.w > coreArea / g_place_coreBounds.h ? g_place_coreBounds.w : coreArea / g_place_coreBounds.h;
    ...
    // north pads
    northPads = remainingPads / 4;
    remainingPads -= northPads;
    nextPos = 0;
    ...
    // south pads
    southPads = remainingPads / 3;
    remainingPads -= southPads;
    nextPos = 0;
    ...
    // east pads
    eastPads = remainingPads / 2;
    remainingPads -= eastPads;
    nextPos = 0;
