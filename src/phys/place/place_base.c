...
void addConcreteNet(ConcreteNet* net) {
    ...
    if (net->m_id >= g_place_concreteNetsSize) {
        g_place_concreteNetsSize = (net->m_id > g_place_concreteNetsSize ? net->m_id : g_place_concreteNetsSize);
...
void delConcreteNet(ConcreteNet* net) {
    ...
    while (!g_place_concreteNets[g_place_numNets - 1])
        g_place_numNets--;
}
...
void addConcreteCell(ConcreteCell* cell) {
    ...
    if (cell->m_id >= g_place_concreteCellsSize) {
        g_place_concreteCellsSize = (cell->m_id > g_place_concreteCellsSize ? cell->m_id : g_place_concreteCellsSize);
...
void delConcreteCell(ConcreteCell* cell) {
    ...
    while (!g_place_concreteCells[g_place_numCells - 1])
        g_place_numCells--;
