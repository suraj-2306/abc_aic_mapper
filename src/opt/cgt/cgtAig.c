...
void Cgt_ManDetectFanout(Aig_Man_t* pAig, Aig_Obj_t* pObj, int nOdcMax, Vec_Ptr_t* vFanout) {
    ...
    Vec_PtrForEachEntry(Aig_Obj_t*, vFanout, pObj, i) {
        ...
        Aig_ObjForEachFanout(pAig, pObj, pFanout, iFanout, f) if (!Aig_ObjIsTravIdCurrent(pAig, pFanout)) break;
...
***********************************************************************/
static inline Aig_Obj_t* Aig_ObjChild0CopyVec(Vec_Ptr_t* vCopy, Aig_Obj_t* pObj) { return Aig_NotCond((Aig_Obj_t*)Vec_PtrEntry(vCopy, Aig_ObjFaninId0(pObj)), Aig_ObjFaninC0(pObj)); }
static inline Aig_Obj_t* Aig_ObjChild1CopyVec(Vec_Ptr_t* vCopy, Aig_Obj_t* pObj) { return Aig_NotCond((Aig_Obj_t*)Vec_PtrEntry(vCopy, Aig_ObjFaninId1(pObj)), Aig_ObjFaninC1(pObj)); }
...
Aig_Man_t* Cgt_ManDupPartition(Aig_Man_t* pFrame, int nVarsMin, int nFlopsMin, int iStart, Aig_Man_t* pCare, Vec_Vec_t* vSuppsInv, int* pnOutputs) {
    ...
    Vec_PtrForEachEntry(Aig_Obj_t*, vPos, pObj, i)
        pObj->pData
        = (Aig_Obj_t*)Aig_ObjCreateCo(pNew, (Aig_Obj_t*)Vec_PtrEntry(vRoots, i));
    if (pnOutputs != NULL)
