...
void Abc_NtkPrintMeasures(unsigned* pTruth, int nVars) {
    ...
    for (i = 0; i < nVars; i++)
        for (k = 0; k < nVars; k++) {
            ...
            nOnes = Kit_TruthCountOnes(uCofs[6], nVars) + Kit_TruthCountOnes(uCofs[7], nVars) + Kit_TruthCountOnes(uCofs[8], nVars) + Kit_TruthCountOnes(uCofs[9], nVars);
